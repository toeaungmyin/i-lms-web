...
<form action="{{ route('dashboard.courses.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div class="grid gap-6 grid-cols-2">
            <div>
                <label for="assignment_grade_percent" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Assignment Grade Percent</label>
            ...
            <div>
                <label for="exam_grade_percent" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Exam Grade Percent</label>
